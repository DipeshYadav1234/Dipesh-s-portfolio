      ...
      <div className="projects">
          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/DipeshYadav1234" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="GitHub" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>GYM Buddy Application</h3>
              <p>
                A Fitness-focused mobile app designed to enhance users' workout experiences by providing a comprehensive and engaging fitness journey. 
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Survey Form Website</h3>
              <p>An online survey platform designed to collect and analyze people's opinions on a wide range of services, products, and experiences.</p>
            </div>
            <footer> <ul className="tech-list"> <li>My Sql</li> <li>PHP</li> <li>Laravel</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>
                A Flight Price Prediction System is an online platform that leverages historical flight data, real-time market trends, and machine 
                learning algorithms to accurately forecast future airfare prices.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
